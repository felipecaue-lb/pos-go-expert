...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x10.pb.ListCategory\"\x00(\x01\x12R\n" +
	"!CreateCategoryStreamBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00(\x010\x01\x12/\n" +
	"\x0eListCategories\x12\t.pb.blank\x1a\x10.pb.ListCategory\"\x00\x125\n" +
...
var file_proto_course_category_proto_depIdxs = []int32{
	1, // 0: pb.ListCategory.categories:type_name -> pb.Category
	...
	3, // 7: pb.CategoryService.CreateCategoryStream:output_type -> pb.ListCategory
	1, // 8: pb.CategoryService.CreateCategoryStreamBidirectional:output_type -> pb.Category
	3, // 9: pb.CategoryService.ListCategories:output_type -> pb.ListCategory
