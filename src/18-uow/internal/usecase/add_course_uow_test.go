...
import (
	...
	"github.com/felipecaue-lb/pos-go-expert/src/18-uow/internal/db"
	"github.com/felipecaue-lb/pos-go-expert/src/18-uow/internal/repository"
	"github.com/felipecaue-lb/pos-go-expert/src/18-uow/pkg/uow"
...
func TestAddCourseUow(t *testing.T) {
	dbt, err := sql.Open("mysql", "root:admin@tcp(mysql-db:3306)/goexpert")
